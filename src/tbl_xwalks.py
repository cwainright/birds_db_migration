...
def _ncrn_BirdDetection(xwalk_dict:dict) -> dict:
    ...
    xwalk_dict['ncrn']['BirdDetection']['xwalk']['source'] = np.where(mask, "xwalk_dict['ncrn']['BirdDetection']['tbl_load']['DetectionNotes']='Previously_Obs: ' + xwalk_dict['ncrn']['BirdDetection']['source']['Previously_Obs'].astype(str) + '; Initial_Three_Min_Cnt: ' + xwalk_dict['ncrn']['BirdDetection']['source']['Initial_Three_Min_Cnt'].astype(str)", xwalk_dict['ncrn']['BirdDetection']['xwalk']['source'])
    ...
    xwalk_dict['ncrn']['BirdDetection']['xwalk']['source'] = np.where(mask, "xwalk_dict['ncrn']['BirdDetection']['tbl_load']['ImportNotes']='Previously_Obs: ' + xwalk_dict['ncrn']['BirdDetection']['source']['Previously_Obs'].astype(str) + '; Initial_Three_Min_Cnt: ' + xwalk_dict['ncrn']['BirdDetection']['source']['Initial_Three_Min_Cnt'].astype(str)", xwalk_dict['ncrn']['BirdDetection']['xwalk']['source'])
